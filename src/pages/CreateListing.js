...
const handleImageSubmit = (e) => {
  ...
  const handleCreateList = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_DOMAIN_URL}/api/listing/create`, {
        ...formData,
        userRef: user._id,
...
return (
   <>
     <h1 className='text-center mt-12 mb-[-20px] font-bold text-2xl'>Create a Listing</h1>
          ...
          {formData.imageurls.length > 0 &&
            formData.imageurls.map((url, index) => (
              ...
              >
                ...
                <button className='text-center text-white bg-slate-700 rounded-lg p-2 hover:opacity-90'
                 type='button' disabled={loading || uploading} onClick={handleCreateList}>
